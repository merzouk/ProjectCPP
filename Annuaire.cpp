...
namespace Manage {
       ...
       void Annuaire::display() {
              ...
              cout << "Identifiant  " << "Nom  " << "Prenom  " << "Sexe  "
                            << "Statut juri " << "Libelle  " << "Complement  " << "Code Post  "
                            << "Ville  " << "Mail de contact " << "Date de naiss" << endl;
              cout
                            << "*****************************************************************************************************************************************"
                            << endl;
              map<string, Contact*>::iterator it = this->map_annuaire.begin();
       ...
       void Annuaire::print_contact_prive(ContactPrive *contact_prive) {
              ...
              cout << contact_prive->get_identifiant() << "  " << contact_prive->get_nom()
                            ...
                            << contact_prive->get_dateNaissance()->get_annee() << endl;
       }

       void Annuaire::print_contact_professionnel(ContactProfessionel *contact_prof) {
              if (!contact_prof)
                     return;
              cout << contact_prof->get_identifiant() << "  " << contact_prof->get_nom()
                            ...
                            << contact_prof->get_email() << "              " << endl;
       }

       void Annuaire::load_annuaire_from_files(string fileContactPrivate,
       ...
       DateNaissance* Annuaire::build(string dat) {
              ...
              DateNaissance *datenaissance = new DateNaissance(str_to_int(jour),
                            str_to_int(mois), str_to_int(annee));
