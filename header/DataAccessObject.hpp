...
/**
* Cette partie accède à la base de données, pour remplacer l'annuaire
*
*/
namespace Manage
{
       class DataAccessObject: public Tools<string, int, Contact>
       {
             private:
                     Utils * utils;

              public:
                     DataAccessObject(){ this->utils = new Utils();}
                     ~DataAccessObject()
                     {
                               delete this->utils;
                               this->utils = nullptr;
